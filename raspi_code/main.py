...
if __name__ == "__main__":
    try:
        ...
        sensor_thread = threading.Thread(target=sensor_jarak_tempuh.tempuh_to_posgrid, args=(pause_event, sensorPin,))
        sensor_thread.daemon = True 
        sensor_thread.start()
        
        while True:
            # ada fungsi next move disini dengan outputny adalah nextmove 0/1/2/3 .....
            ...
            # ada fungsi buat ngecek keadaan sekitar (mencari jalan yang bisa dilalui)
            stop(IN1, IN2, IN3, IN4)
            time.sleep(1)
            check_around()
